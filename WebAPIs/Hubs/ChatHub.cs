...
namespace whatsAppClone.Hubs
{
    public class ChatHub : Hub
    {
        ...
        public  async Task addContact(string _from, string _to, string join)
        {
            Users from = db.Users.Where(o => o.Username == _from).FirstOrDefault();
            Users to = db.Users.Where(o => o.Username == _to).FirstOrDefault();
            object from_ = new
            {
            ...
            .SendAsync("addContact‏‎‏‎", messagesData);
        }
        [EnableCors("AllowOrigin")]
